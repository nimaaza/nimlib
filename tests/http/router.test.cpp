...
TEST(HttpRouter, RepeatedNameInTarget)
{
    ...
    route_handler handler_1 = [&handler_1_invoked](const Request&, Response& response, params_t&) -> void
    {
        handler_1_invoked = true;
        response.body = "touched_by_handler_1";
    };

    route_handler handler_2 = [&handler_2_invoked](const Request&, Response& response, params_t&) -> void
    {
        handler_2_invoked = true;
        response.body = "touched_by_handler_2";
    };

    route_handler handler_3 = [&handler_3_invoked](const Request&, Response& response, params_t&) -> void
    {
    ...
    bool routing_result_1 = router.route(request_1, response_1);
    bool routing_result_2 = router.route(request_2, response_2);
    bool routing_result_3 = router.route(request_3, response_3);
...
TEST(HttpRouter, RepeatedNameInTargetWithParams)
{
    ...
    route_handler handler_1 = [&](const Request&, Response& response, params_t& params) -> void
    {
        handler_1_invoked = true;
    ...
    route_handler handler_2 = [&](const Request&, Response& response, params_t& params) -> void
    {
        handler_2_invoked = true;
    ...
    route_handler handler_3 = [&](const Request&, Response& response, params_t& params) -> void
    {
        handler_3_invoked = true;
...
TEST(HttpRouter, AddSubroutes)
{
    ...
    auto get_handler_1_1_1 = [&](const Request&, Response&, params_t&)
    {
        get_handler_1_1_1_invoked = true;
    };
    auto get_handler_1_1_2 = [&](const Request&, Response&, params_t&)
    {
        get_handler_1_1_2_invoked = true;
    };
    auto get_handler_1_2_1 = [&](const Request&, Response&, params_t&)
    {
        get_handler_1_2_1_invoked = true;
    };
    auto post_handler_1_1_1 = [&](const Request&, Response&, params_t&)
    {
    ...
    bool get_routing_result_1_1_1 = main_router.route(get_request_1_1_1, get_response_1_1_1);
    bool get_routing_result_1_1_2 = main_router.route(get_request_1_1_2, get_response_1_1_2);
    bool get_routing_result_1_2_1 = main_router.route(get_request_1_2_1, get_response_1_2_1);
    bool post_routing_result_1_1_1 = main_router.route(post_request_1_1_1, post_response_1_1_1);
...
TEST(HttpRouter, AddSubroutesWithParamsInSubRoute)
{
    ...
    auto handler = [&](const Request&, Response&, params_t& params)
    {
        handler_invoked = true;
    ...
    bool routing_result = main_router.route(request, response);
